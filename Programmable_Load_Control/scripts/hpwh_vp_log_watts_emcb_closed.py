...
def hpwh_vp_vs_log_loadup(log,vp):
    ...
    ax.plot(x2,y2,label='VP Recorded Data')
    ...
    ax.set_title('HPWH Consumed Watts: WH Station and VP')
    ax.annotate('Load Up Command Received',xy=('05:55',0),xytext=(0,200),arrowprops=dict(arrowstyle='-|>'))
