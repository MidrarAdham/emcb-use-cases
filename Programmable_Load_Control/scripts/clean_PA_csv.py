...
user = input()
if user == '1':
    destination = '~/Desktop/EMCB/emcb-usecases/Programmable_Load_Control/Data/ewh_hpwh/Day1_Data/'
    print(colored('The file is saved at: ',destination,'cyan'))
elif user == '2':
    destination = '~/Desktop/EMCB/emcb-usecases/Programmable_Load_Control/Data/ewh_hpwh/Day2_Data/'
    print(colored('The file is saved at: ',destination,'cyan'))
else:
    destination = '~/Desktop/EMCB/emcb-usecases/Programmable_Load_Control/Data/ewh_hpwh/Day3_Data/'
    print('\n \n \n The file is save at: \n \n \n',destination)
