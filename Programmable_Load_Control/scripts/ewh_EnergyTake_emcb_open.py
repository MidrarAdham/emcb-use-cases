...
def ewh_energyTake_no_loadup(log):
    ...
    ax.annotate('VP Shed Command Received (NR)',xy=('17 18:55',0),xytext=('17 16:29',-100),arrowprops=dict(arrowstyle='-|>'))
    ax.annotate('VP Shed Command Received (NR)',xy=('17 19:55',0),xytext=('17 16:29',-100),arrowprops=dict(arrowstyle='-|>'))
