...
def ewh_vp_vs_log_no_loadup(log,vp):
    ...
    ax[0].annotate('VP Shed Command Received',xy=('17 18:55',0),xytext=('17 13:55',1000),arrowprops=dict(arrowstyle='-|>'))
    ax[0].annotate('VP Shed Command Received (NR)',xy=('17 19:55',0),xytext=('17 13:55',500),arrowprops=dict(arrowstyle='-|>'))
    ax[1].annotate('VP Shed Command Received',xy=('17 06:45',0),xytext=('17 00:45',500),arrowprops=dict(arrowstyle='-|>'))
    ax[1].annotate('VP Shed Command Received',xy=('17 18:55',0),xytext=('17 13:55',1000),arrowprops=dict(arrowstyle='-|>'))
    ax[1].annotate('VP Shed Command Received (NR)',xy=('17 19:55',0),xytext=('17 13:55',500),arrowprops=dict(arrowstyle='-|>'))
    ...
    ax[0].annotate('VP Shed Command Received (NR)',xy=('18 19:55',0),xytext=('18 13:55',500),arrowprops=dict(arrowstyle='-|>'))
    ...
    ax[1].annotate('VP Shed Command Received (NR)',xy=('18 19:55',0),xytext=('18 13:55',500),arrowprops=dict(arrowstyle='-|>'))
    fig.tight_layout()
    #plt.show()
