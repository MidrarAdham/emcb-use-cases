...
path="/home/parallels/Desktop/emcb-use-cases/Programmable_Load_Control/Data/final_logs/hpwh_logs/vp_data/hpwh_vp_loadup_emcb_closed.csv"
df = pd.read_csv(path)

destination='/home/parallels/Desktop/emcb-use-cases/Programmable_Load_Control/Data/final_logs/hpwh_logs/vp_data/hpwh_vp_load_up_emcb_closed_resampled.csv'
...
def resampling_timestamp(path,destination):
    ...
    #clean = clean.resample('1Min').sum()               # Put zeroes in the other column values
